...
export default function Index() {
  return (
    <div className='py-20 text-black font-primary mx-5 xl:mx-20'>
      ...
      <div className='grid grid-cols-3 xl:grid-cols-8 gap-5 mt-3'>
      ...
      <div className='mt-3 xl:mt-20 flex justify-between'>
      ...
      <div className='mt-3 grid grid-cols-2 xl:grid-cols-3 xl:gap-5 gap-3'>
      ...
      <div className='mt-5 xl:mt-20  flex justify-between'>
        <h3 className='font-semibold text-lg xl:text-5xl'>
          Search Results
        </h3>
