...
export default function Index() {
  return (
    <div className='py-20 text-black font-primary mx-8 xl:mx-44 font-thin'>
        ...
        <div className='mb-5'>
            <p className='text-sm xl:text-2xl'>Phone</p>
        ...
        <div>
         <p className='text-sm xl:text-2xl'>Gender</p>
        ...
        <div className='mt-8'>
            <button className='font-medium btn-pop text-white rounded-full xl:text-2xl bg-[#FF5A5F] px-5 py-2'>Save Changes</button>
        </div>
    </div>
  )
}
