...
export default function Index() {
    ...
    return (
        <div className='py-20 text-black font-primary  font-thin'>
            ...
            <div className='grid grid-cols-2 mx-8 gap-5 mt-3 pb-5 border-b shadow-b-md'>
            ...
            <div className='my-5 mx-8'>
                <p className='text-sm'>Monthly Rent To Be Charged (5000 to 300000)</p>
            ...
            <div className='my-5 p-3 bg-[#FFF5F5] flex flex-col gap-3 text-xs'>
        ...
        <button className='font-medium btn-pop text-white rounded-full bg-[#FF5A5F] px-10 py-2'>Buy Subscription</button>
    </div>
