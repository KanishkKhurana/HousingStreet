...
export default function Description(props) {
  return (
    <div className='px-5 py-8 border-b border-black/50 shadow-md'>
        <div className='flex justify-between'>
            <h3 className='font-bold text-[#FF5A5F]'>2BHK</h3>
            <p className='border rounded-full px-5 py-1 text-xs border-black'>For Rent</p>
        </div>
        <div>
            <h1 className='font-bold text-lg mt-2'>Flat / Apartment (Non-Furnished)</h1>
            <div className=" mt-1 flex gap-2 font-thin items-center text-sm">
            <BiCurrentLocation className="" />
            <button className="">Chattarpur, Delhi</button>
            </div>
        </div>
        <div className='flex justify-evenly text-[0.75rem] gap-3 my-5'>
        ...
        <div className='text-sm font-thin mt-3'>
            ...
            <button className='border my-3 w-fit text-[#FF5A5F] rounded-full px-5 py-1 text-xs border-[#FF5A5F]'>Add To Compare</button>


        </div>

        <h3 className='font-semibold mt-2'>Amentites</h3>
        <div className='grid grid-cols-4 mt-3 font-thin text-sm'>
        ...
        <h1 className='mt-8 font-semibold'>Details</h1>
        <div className='flex justify-between gap-3 text-xs mt-2 font-thin'>
            <div className=''>
        ...
        <h1 className='mt-8 font-semibold'>Other Details</h1>
        <div>
            <ul className='font-thin list-disc ml-5 mt-2 text-sm'>
        ...
        <p className='font-thin mt-8 text-xs'>Price</p>
        <div className='flex justify-between items-center'>
            <div className='flex  gap-1 items-center '>
                <h3 className='font-secondary text-xl'>₹ {"14,999"}</h3>
                <p className='font-thin text-[10px]'>/ month</p>
            </div>
            <div>
            <button className='border my-3 w-fit text-[#FF5A5F] rounded-xl px-8 py-1 text-xl btn-pop font-medium border-[#FF5A5F]'>Book Now</button>
            </div>
        </div>
